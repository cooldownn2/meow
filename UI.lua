...
function formatConfigName(filePath)
...
function library:saveConfig()
    ...
    writefile(configPath, game:GetService("HttpService"):JSONEncode(config))
    library:notify("Updated config: " .. name)
end
...
function library:loadConfig()
    ...
    if not isfile(configPath) then
        return library:notify("Config does not exist!")
    end
...
function library:deleteConfig()
    ...
    if isfile(configPath) then
        ...
        library:notify("Config does not exist!")
    end
end
